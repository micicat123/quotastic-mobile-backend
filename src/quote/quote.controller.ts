...
export class QuoteController {
  ...
  @UseGuards(AuthGuard)
  @Get('/user-decisions/:user_id')
  async decisions(@Param() user_id: any) {
    return this.quoteService.getDecisions(user_id.user_id);
  }
  ...
  async create(
    ...
    if (body.quote.length < 5)
      throw new BadRequestException('Your quote is too short!');
  ...
  @UseGuards(AuthGuard)
  @Put('/:id')
  async update(@Param('id') id: any, @Body() body: QuoteUpdateDto) {
